...
var outputPt1 = new String;
outputPt1 = "<h3> Today is "+ month + '/' + day + '/' + year + "</h3>";
...
var boolNum1 = Number.isNaN(num1);
//    c. Check if it is an integer using Number.isInteger()
var isIntNum1 = Number.isInteger(num1);
...
var num1String = "Original: " + num1 + " -> Converted:" + convertedNum1 + " -> isNaN: " + boolNum1 + " -> isInteger: " + isIntNum1;
// TODO:
// 4. Combine all your results into ONE string
//    (you can use + to join multiple strings)
var outputPt2 = "<h3>" + num1String + "<br>" + num1String + "</h3>";
// TODO:
